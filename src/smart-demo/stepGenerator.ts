...
function makeStep(segment: DemoSegment, index: number, previousSegment?: DemoSegment): DemoStep {
	switch (segment.action) {
		...
		case "typing": {
			...
			const dur = segment.endTimestamp ? segment.endTimestamp - segment.timestamp : 2;
			return {
				number: index + 1,
				title: "Enter text",
