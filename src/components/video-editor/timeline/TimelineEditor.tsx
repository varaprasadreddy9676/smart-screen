...
function Timeline({
	...
	const visiblePartitionedItems = useMemo<TimelinePartitionedItems>(() => {
		return partitionTimelineItems(filterTimelineItemsByRange(items, range));
	}, [items, range]);
